...
Route::get('/', function () {
    ...
    Route::group(['prefix'=>'entradas', 'where'=>['id'=>'[0-9]+']], function() {
        ...
        Route::get('{id}/edit',    ['as'=>'entradas.edit',    'uses'=>'EntradasController@edit'   ]);
    ...
    Route::group(['prefix'=>'saidas', 'where'=>['id'=>'[0-9]+']], function() {
        ...
        Route::get('{id}/edit',    ['as'=>'saidas.edit',    'uses'=>'SaidasController@edit'   ]);
    ...
    Route::group(['prefix'=>'tipo_entradas', 'where'=>['id'=>'[0-9]+']], function() {
        ...
        Route::get('{id}/edit',    ['as'=>'tipo_entradas.edit',    'uses'=>'TipoEntradasController@edit'   ]);
    ...
    Route::group(['prefix'=>'tipo_saidas', 'where'=>['id'=>'[0-9]+']], function() {
        ...
        Route::get('{id}/edit',    ['as'=>'tipo_saidas.edit',    'uses'=>'TipoSaidasController@edit'   ]);
    ...
    Route::group(['prefix'=>'tipo_clientes', 'where'=>['id'=>'[0-9]+']], function() {
        ...
        Route::get('{id}/edit',    ['as'=>'tipo_clientes.edit',    'uses'=>'TipoClientesController@edit'   ]);
