                                        ...
                                        <div class="btn-toolbar mb-3" role="toolbar"
                                            ...
                                            <div class="btn-group mr-2" role="group" aria-label="Primeiro grupo">
                                                <div class="btn-group float-sm-left" role="group"
                                                    ...
                                                    <a href="{{ route('clientes.create', []) }}" type="button"
                                                        class="btn btn-padrao1">Cadastrar <i class="fa fa-user-plus"
                                                            aria-hidden="true"></i></a>
                                                    <a href="{{ route('tipo_clientes.create', []) }}" type="button"
                                                        class="btn btn-padrao2">Cadastrar Tipo de
