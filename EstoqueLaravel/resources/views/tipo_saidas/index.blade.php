    ...
    <table class="table table-hover">
        ...
        <tbody>
          @foreach ($tipo_saidas as $tipo_saida)
            ...
            <td></td>     
            <td>
              <a href="{{ route('tipo_saidas.edit', ['id'=>\Crypt::encrypt($tipo_saida->id)]) }}" class="btn btn-success">
              ...
              <a href="#" onclick="return ConfirmaExclusao({{$tipo_saida->id}})" class="btn btn-danger">
