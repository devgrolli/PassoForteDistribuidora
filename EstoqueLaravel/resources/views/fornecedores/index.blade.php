...
@extends('layouts.default')
    ...
    <div class="float-sm-left">
      <a href="{{ route('fornecedores.create', []) }}" class="btn btn-primary">Cadastrar</a><br></br>
    </div>  
        ...
        <tbody>
          @foreach ($fornecedores as $fornecedor)
            ...
            <td>{{ $fornecedor->telefone}}</td>
              <td>
                <a href="{{ route('fornecedores.edit', ['id'=>$fornecedor->id]) }}" class="btn-sm btn-success">Editar</a>
