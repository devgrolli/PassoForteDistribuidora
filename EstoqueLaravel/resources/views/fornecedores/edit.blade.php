  ...
  @include('layouts.alerts')
    <div class="card">
      <div class="card-header" style="background: rgb(52, 58, 64)">
        <h3 style="color:rgb(255, 255, 255)"><strong>Editando: </strong>{{ $fornecedor->razao_social }}</h3>
      </div>
        ...
        {!! Form::open(['route'=> ["fornecedores.update", 'id'=>$fornecedor->id], 'method'=>'put']) !!}
          ...
          <div class="form-row">
            ...
            <div class="col">
              ...
              {!! Form::text('endereco', $fornecedor->endereco, ['class'=>'form-control', 'disabled']) !!}
            </div>
          ...
          <div class="form-row">
            ...
            <div class="col">
              ...
              {!! Form::text('bairro', $fornecedor->bairro, ['class'=>'form-control', 'disabled']) !!}
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="col">
              ...
              {!! Form::text('cidade', $fornecedor->cidade, ['class'=>'form-control', 'disabled']) !!}
            </div>

            <div class="col">
              {!! Form::label('estado', 'Estado') !!}
              {!! Form::text('estado', $fornecedor->estado, ['class'=>'form-control', 'disabled']) !!}
            </div>
