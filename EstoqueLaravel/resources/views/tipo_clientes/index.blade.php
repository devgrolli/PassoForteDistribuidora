    ...
    <table class="table table-hover">
        ...
        <tbody>
          @foreach ($tipo_clientes as $tipo_cliente)
            ...
            <td>
              <a href="{{ route('tipo_clientes.edit', ['id'=>\Crypt::encrypt($tipo_cliente->id)]) }}" class="btn btn-success">
              ...
              <a href="#" onclick="return ConfirmaExclusao({{$tipo_cliente->id}})" class="btn btn-danger">
