@extends('layouts.default')
    ...
    <div class="btn-group" role="group" aria-label="Exemplo básico">
      ...
      <a href="{{ route('tipo_entradas.create', []) }}" type="button" class="btn btn-padrao2">Cadastrar Tipo de Entrada</a>
    </div><br><br>  
        ...
        <tbody>
          @foreach ($entradas as $entrada)
            ...
            <td>{{ $entrada->tipo_entrada->nome }}</td>
              <td>
                <a href="{{ route('entradas.edit', ['id'=>\Crypt::encrypt($entrada->id)]) }}" class="btn btn-padrao1">
                ...
                <a href="#" onclick="return ConfirmaExclusao({{$entrada->id}})" class="btn btn-padrao2">
