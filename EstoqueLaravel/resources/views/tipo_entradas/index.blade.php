    ...
    <table class="table table-hover">
        ...
        <tbody>
          @foreach ($tipo_entradas as $tipo_entrada)
            ...
            <td>
              <a href="{{ route('tipo_entradas.edit', ['id'=>\Crypt::encrypt($tipo_entrada->id)]) }}" class="btn btn-success">
              ...
              <a href="#" onclick="return ConfirmaExclusao({{$tipo_entrada->id}})" class="btn btn-danger">
