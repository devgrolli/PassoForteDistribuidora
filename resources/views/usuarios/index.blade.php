                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal" data-target='#editModal'
                                                onclick="editarModal('{{ $usuario->id }}');"
                                            ...
                                            <a href="#" onclick="return ConfirmaExclusao({{ $usuario->id }})" class="btn btn-padrao2-icons">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="crud-alignment-modal">
                        {!! Form::open(['route'=> "usuarios.update", 'method'=>'put']) !!}
                        <div class="modal-body">
                        ...
                        <div class="modal-body">
                            {!! Form::label('email', 'E-mail') !!}
                            {!! Form::email('email', null, ['class'=>'form-control email-div', 'required']) !!}
                        </div>
                        <div class="modal-body">
                            {!! Form::label('password', 'Senha') !!}
                            {!! Form::text('password', null, ['class' => 'form-control senha-div', 'required']) !!}
                        </div>
                    </div>
                    <br>
                    <div class="modal-footer">
